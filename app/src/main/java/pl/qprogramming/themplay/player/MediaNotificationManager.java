...
public class MediaNotificationManager {
    ...
    public void createMediaNotification(Song song, boolean pause) {
        ...
        val builder = new NotificationCompat.Builder(mService, CHANNEL_ID)
                ...
                .addAction(R.drawable.ic_previous_32, "Previous", PendingIntent.getBroadcast(mService, NOTIFICATION_ID, new Intent(PLAYBACK_NOTIFICATION_PREV.getCode()), PendingIntent.FLAG_IMMUTABLE))
                .addAction(R.drawable.ic_stop_32, "Stop", PendingIntent.getBroadcast(mService, NOTIFICATION_ID, new Intent(PLAYBACK_NOTIFICATION_STOP.getCode()), PendingIntent.FLAG_IMMUTABLE));
        if (pause) {
            builder.addAction(R.drawable.ic_play_32, "Play", PendingIntent.getBroadcast(mService, NOTIFICATION_ID, new Intent(PLAYBACK_NOTIFICATION_PLAY.getCode()), PendingIntent.FLAG_IMMUTABLE));
        } else {
            builder.addAction(R.drawable.ic_pause_32, "Pause", PendingIntent.getBroadcast(mService, NOTIFICATION_ID, new Intent(PLAYBACK_NOTIFICATION_PAUSE.getCode()), PendingIntent.FLAG_IMMUTABLE));
        }
        builder.addAction(R.drawable.ic_next_32, "Next", PendingIntent.getBroadcast(mService, NOTIFICATION_ID, new Intent(PLAYBACK_NOTIFICATION_NEXT.getCode()), PendingIntent.FLAG_IMMUTABLE))
